...
// 15 → 5 burned data on transient strap stalls (premature persistAndFinish
// ACK'd an incomplete batch). 10 s keeps ~6× headroom over the healthy
// ~150 ms inter-batch gap without doubling iteration wall-clock.
