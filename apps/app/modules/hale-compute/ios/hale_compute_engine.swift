...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeComputeFfiError: FfiConverterRustBuffer {
    typealias SwiftType = ComputeFfiError

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ComputeFfiError {
        ...
        case 2: return .UnsupportedSchemaVersion(
            message: try FfiConverterString.read(from: &buf)
        )
    ...
    public static func write(_ value: ComputeFfiError, into buf: inout [UInt8]) {
        switch value {
        ...
        case .UnsupportedSchemaVersion(_ /* message is ignored*/):
...
extension ComputeFfiError: Equatable, Hashable {}

extension ComputeFfiError: Foundation.LocalizedError {
    public var errorDescription: String? {
