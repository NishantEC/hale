...
export function SleepTab({
  ...
  return (
    <div className="space-y-10 max-w-6xl">
      ...
      {empty && (
        <div className="bg-surface-1 border border-border rounded-2xl p-6 text-text-2 text-sm">
          No sleep detection for {selectedDate}. Try a different date, or rerun the pipeline for
          this night.
        </div>
      )}
      ...
      <div>
        <div className="flex items-baseline justify-between mb-3">
          ...
          <span className="text-text-2 text-xs">{epochs.length} epoch windows</span>
        </div>
        ...
        <div>
          ...
          <div className="mt-3">
            ...
            <Row
              k="Continuity"
              v={
                <span title="Fraction of sleep time without major interruption. Higher is better (0–1).">
            ...
            <Row
              k="Coverage"
              v={
                <span title="Fraction of expected sensor data actually present. Higher is better (0–1).">
            ...
            <Row
              k="Confidence"
              v={
                <span title="Detector confidence in this sleep window. Higher is better (0–1).">
        ...
        <div>
          ...
          <div className="mt-3">
            ...
            <Row
              k="Regularity"
              v={
                <span title="Bedtime/wake-time consistency vs your baseline. Higher is better (0–1).">
